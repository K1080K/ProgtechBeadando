...
public class Headhunter extends Character {
    ...
    public Headhunter(String name, int gold, boolean party_member, boolean alive, int age, Race race, Caste caste, int level) throws InvalidAgeException, InvalidAttributeException {
