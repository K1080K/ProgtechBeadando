...
public class Warrior extends Character {
    ...
    public Warrior(String name, int gold, boolean party_member, boolean alive, int age, Race race, Caste caste, int level) throws InvalidAttributeException, InvalidAgeException {
