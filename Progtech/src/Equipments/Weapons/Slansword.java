...
public class Slansword extends EquipmentDecorator {

    public Slansword(IEquipment ieqp) {
        super(ieqp);
    }

    public String EquipmentName() {
        return super.EquipmentName() + DecorateWithSlansword();
    }
    private String DecorateWithSlansword() {
        return "Slan sword";
    }
    ...
    private int DecorateWithPrice() { return 100000; }

    public int DamageIndex() {
        return super.DamageIndex() + DecorateWithDamage();
    }
    private int DecorateWithDamage() { return 6; }

    public int ModifyOnAP() { return super.ModifyOnAP() + DecorateWithAP(); }
    private int DecorateWithAP() { return -5; }
    ...
    private int DecorateWithDP() { return -8; }
}
